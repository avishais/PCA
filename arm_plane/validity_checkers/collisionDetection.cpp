...
// Returns 0 if no collision
{
	...
	if(withObs) {
		...
		PQP_Tolerance(&res[89],Rtable,Ttable,&table,R6,T6,&link6,tolerance);
		PQP_Tolerance(&res[90],Rtable,Ttable,&table,R7,T7,&link7,tolerance);
		PQP_Tolerance(&res[91],Rtable,Ttable,&table,REE2,TEE2,&EE2,tolerance);
		PQP_Tolerance(&res[92],Rtable,Ttable,&table,R52,T52,&link52,tolerance);
		PQP_Tolerance(&res[93],Rtable,Ttable,&table,R62,T62,&link62,tolerance);
		PQP_Tolerance(&res[94],Rtable,Ttable,&table,R72,T72,&link72,tolerance);
