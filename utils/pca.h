...
public:
	 ...
	 * @param num_records_knn Number of records in each search
	 * @throws std::invalid_argument if num_vars is smaller than two
	 */
	explicit pca(long num_vars, int num_records_knn = 100);
	/**
	 * @brief Destructor
	 */
	virtual ~pca();
	...
	/**
	 * @brief Clear all previous added records
	 * Addition by Avishai Sintov Dec. 8, 2017
	 */
	void clear_records();
	/**
	 * @brief Print all current records
	 * Addition by Avishai Sintov Dec. 8, 2017
	 */
	void print_records();
	 ...
	 * Addition by Avishai Sintov Dec. 11, 2017
	 */
	void set_num_records(int k);
	/**
